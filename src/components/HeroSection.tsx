...
export function HeroSection({
  ...
  return (
    <section className="relative w-full bg-[#fbfbfe] bg-graph-grid overflow-hidden pt-6 sm:pt-10 pb-4 sm:pb-24 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative min-h-[480px] sm:min-h-[540px] flex flex-col justify-center">
        ...
        <div className="hidden lg:block pointer-events-none">
          ...
          <div className="absolute left-24 xl:left-32 top-36 z-20 pointer-events-auto bg-white rounded-2xl p-4 shadow-xl border border-slate-100 w-52 xl:w-56 animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <div className="text-xs font-bold text-[#050316]">Software Engineer</div>
            <div className="flex items-center gap-1 text-[11px] text-slate-400 mb-2.5">
              <span>Microsoft</span>
              <BadgeCheck className="w-3.5 h-3.5 text-[#f97415] fill-[#f97415]/10" />
            </div>
        ...
        <div className="hidden lg:block pointer-events-none">
          ...
          <div className="absolute right-20 xl:right-28 bottom-6 z-20 pointer-events-auto bg-white rounded-2xl p-4 shadow-xl border border-slate-100 w-52 xl:w-56 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="text-xs font-bold text-[#050316]">Product Designer</div>
            <div className="flex items-center gap-1 text-[11px] text-slate-400 mb-2.5">
        ...
        <div className="relative z-30 max-w-2xl mx-auto text-center pt-2 sm:pt-4">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-[#dddbff] text-xs font-medium text-[#f97415] shadow-xs mb-4 sm:mb-6 hover:shadow-sm transition-shadow">
            <ThumbsUp className="w-3.5 h-3.5 text-[#f97415] shrink-0" />
            <span>India's Top Rated Job Platform</span>
          </div>

          {/* Headline - Optimized for mobile typography */}
          <h1 className="text-5xl sm:text-5xl lg:text-7xl font-normal font-heading text-[#050316] tracking-normal mb-3 sm:mb-4 px-1 leading-[0.8]">
            Jobs move <span className="text-orange-500 font-normal font-avenue ">fast.</span> <br />
            <span className='text-[2.4rem] sm:text-5xl lg:text-6xl font-heading italic font-thin text-[#050316] tracking-tight'> So do we, <br className='block sm:hidden' /> every single morning. </span>
          </h1>

          {/* Subheadline - Mobile friendly line height & width */}
          <p className="text-xs sm:text-base text-slate-800 font-normal max-w-lg mx-auto leading-relaxed mb-6 sm:mb-8 px-2">
          ...
          <form
            ...
            className="w-full bg-white rounded-2xl sm:rounded-full shadow-lg shadow-slate-200/50 border border-slate-200/80 p-2 sm:p-2.5 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 max-w-xl mx-auto transition-all focus-within:ring-2 focus-within:ring-[#f97415]/20 focus-within:border-[#f97415]"
          >
            {/* Search Input */}
            <div className="flex items-center gap-2.5 px-3.5 w-full sm:w-1/2 py-2.5 sm:py-1.5 min-h-[44px]">
              ...
              <input
                ...
                className="w-full text-sm text-[#050316] placeholder-slate-400 bg-transparent outline-none font-sans"
              />
            </div>
            ...
            <div className="flex items-center gap-2.5 px-3.5 w-full sm:w-1/2 py-2.5 sm:py-1.5 min-h-[44px] relative">
              ...
              <select
                ...
                className="w-full text-sm text-[#050316] bg-transparent outline-none font-sans cursor-pointer appearance-none pr-5"
              >
                {LOCATION_OPTIONS.map((loc) => (
                  <option key={loc} value={loc} className="text-[#050316] bg-white">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto bg-[#f97415] active:bg-[#d95e09] hover:bg-[#ea6305] text-white font-semibold text-sm rounded-xl sm:rounded-full px-7 py-3 min-h-[44px] transition-colors shadow-md hover:shadow-lg shrink-0 flex items-center justify-center gap-2 active:scale-[0.98]"
            >
              Search
            </button>
          </form>
          ...
          <div className="mt-2 pt-4 border-t border-slate-100 flex lg:hidden flex-col items-center justify-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 font-medium">
              <span className="flex items-center gap-1 text-[#f97415] font-semibold">
            ...
            <div className="flex items-center gap-2 pt-1">
              <div className="bg-white rounded-full px-3 py-1 shadow-xs border border-slate-200/70 text-[11px] font-medium text-slate-600 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3 text-[#f97415]" />
                Profile Auto-Match
              </div>
              <div className="bg-white rounded-full px-3 py-1 shadow-xs border border-slate-200/70 text-[11px] font-medium text-slate-600 flex items-center gap-1">
                <BadgeCheck className="w-3 h-3 text-[#f97415]" />
                Verified Employers
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 sm:h-36 bg-gradient-to-b from-transparent via-[#fbfbfe]/70 to-[#fbfbfe] pointer-events-none z-20" />
    </section>
  );
}
